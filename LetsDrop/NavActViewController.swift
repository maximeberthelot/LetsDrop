...
class NavActViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        //Init  and declare differents views
    ...
    @IBAction func recBtn(sender: UIButton) {
        ...
        dropBtn.titleLabel!.textColor = UIColor(hex: "#FAF9F9")
    ...
    @IBAction func dropBtn(sender: UIButton) {
        ...
        recBtn.titleLabel!.textColor = UIColor(hex: "#FAF9F9")
